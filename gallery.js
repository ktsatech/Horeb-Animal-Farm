...
const DEFAULT_FARM_IMAGES = [
    {
        ...
        "category": "layer",
        "alt": "ISA Brown layer hens in a clean poultry house at Horeb Animal Farm, Nyakabirizi, Bushenyi, Uganda"
    },
    {
        ...
        "category": "layer",
        "alt": "ISA Brown layer hens producing eggs at Horeb Animal Farm, Bushenyi, Uganda"
    },
    {
        ...
        "category": "rabbit",
        "alt": "Flemish Giant rabbit breeding buck at Horeb Animal Farm, Nyakabirizi, Bushenyi, Uganda"
    },
    {
        ...
        "category": "pig",
        "alt": "Large White pig at Horeb Animal Farm, Bushenyi, Uganda"
    }
    ...
    grid.innerHTML = images.map((img, index) => `
        <div class="gallery-card" style="animation-delay: ${index * 0.1}s">
            <div class="card-img-wrapper">
                <div class="gallery-img" role="img" aria-label="${escapeHtml(img.alt || img.title)}" style="background-image: url('${img.url}')"></div>
            </div>
            <div class="card-info">
